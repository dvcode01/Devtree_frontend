...
function HandleData({data}: HandleDataProps) {
  ...
  return (
    <div className="space-y-6 text-white">
        ...
        {data.image && <img src={data.image} alt="Imagen de perfil" className="max-[250px] mx-auto" />}
        ...
        <div className="mt-20 flex flex-col gap-6">
            ...
            : <p className="text-white font-bold text-center">No hay enlaces en este perfil</p>}
        </div>
    </div>
  )
}
